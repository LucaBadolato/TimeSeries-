...
```{r fig.width=8, fig.height=5,out.width='60%', fig.cap="\\label{fig:decompose_CO}Additive decomposition into structural components"}
...
```{r, fig.width=20, fig.height=6,  fig.cap="\\label{fig:HMM_results}State-dependent means and standard deviations"}
