...
buildMod <- function(param){dlmModPoly(order=2, dV=param[1], dW=param[2:3], m0=m0_CO, C0=C0_CO)}

fit <- dlmMLE(y, rep(1,3), buildMod, hessian=TRUE)
fit$convergence
unlist(buildMod(fit$par)[c("V","W")])
fit$hessian
...
\textcolor{red}{le serie SO2 e CO mostrano entrambe un breakpoint alla Month 100 e sono positivamente correlate. inoltre entrambi i pollutants dipendono dalla combustione del carbone che potremmo usare come regressore. in questo caso avremmo un multivariate DLM con m=2}
