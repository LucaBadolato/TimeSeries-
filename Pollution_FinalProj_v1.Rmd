...
ts_CO<-ts(louisiana_df$weekly_CO_mean,start=c(2000,1,1),end = c(2016,4,27),frequency = 53)
...
HMM_main<- ggplot(df_to_plot_CO, aes(x=xtime, y=yvalue)) +
                ...
                scale_x_continuous(breaks=seq(0,900,200),labels=format(seq(as.Date("2000/1/1"),as.Date("2016/4/27"), "4 years"), "%Y")) +
...
#option 2
ggarrange(HMM_main, HMM_additional,widths = c(2,1.2))
```
...
\textcolor{red}{le serie SO2 e CO mostrano entrambe un breakpoint alla week 400 e sono positivamente correlate. inoltre entrambi i pollutants dipendono dalla combustione del carbone che potremmo usare come regressore. in questo caso avremmo un multivariate DLM con m=2}
