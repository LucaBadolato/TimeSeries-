...
\item %1
Let's consider activity \texttt{track\_id==38} and restrict our attention to the heart rate (\texttt{bpm}) data.
The time series is plotted in Figure \ref{fig:bpm}.
...
```{r, fig.width=6, fig.height=2.5, fig.cap="\\label{fig:bpm} Recorded bpm of activity 38"}
