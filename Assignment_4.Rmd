...
\item Speed and heart rate have a negative correlation. Apparentely this is counterintuitive, but the real effect if confounded by the fact that speed increases a lot during the downhills where heart rate gets lower. 
\end{itemize}
```{r}
# Correlation plot
