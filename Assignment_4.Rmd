...
\item Nitrogen dioxide (\texttt{NO2}): It is produced as a result of road traffic and other fossil fuel combustion processes. Furthermore, its presencce in air contributes to the formation and modification of other air pollutants, such as particle pollution. This last one consists of a mixture of solids and liquid droplets, some of them so small that can get into the lungs, causing serious health problems. 
