...
```{r, fig.height=6, out.width='100%', fig.cap="\\label{fig: summary}Time-invariant linear growth model: (a) 10-step-ahead forecast; (b) ACF of one-step-ahead forecast errors; (c) Normal probability plot of standardized one-step-ahead forecast errors."}
...
```{r, fig.height=8, out.width='100%', fig.cap="\\label{fig:one-step-forecast_est}One-step-ahead forecast estimates: (a) Homogeneous HMM; (b) Time-varying linear growth; (c) Time-varying seasonal linear growth; (d) Dynamic regression."}
