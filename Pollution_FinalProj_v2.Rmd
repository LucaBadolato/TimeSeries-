...
Seas <- build_seasonal(fit_seasonal$par)
LG_v_seas <- LG_v + Seas
...
# Remove the first item (m_0) in the vector of filtered states
LG_v_seas_filt_est = dropFirst(LG_v_seas_Filt$m)
...
# Plot
colors <- c("Observed data" = "black", "Linear Growth" = "springgreen4", 
            "Basic structural model"="blue", "Dynamic regression"="red")
