...
```{r, fig.width=18, fig.height=3.5, fig.cap="\\label{fig:filt_est} Filtering estimates of alpha (Panel a) and beta (Panel b) with credible intervals"}
...
MLEsum_table <- knitr::kable(MLEsum, "latex", booktabs=T, align="c",
  ...
  footnote(general="Standard errors in parentheses.",
           ...
           footnote_as_chunk=T, escape=F) %>%
  kable_styling(latex_options="hold_position")
add_header_above(MLEsum_table, c("Period 1 to 84" = 2, "Period 85 to 186" = 2,"" = 5))  
```
