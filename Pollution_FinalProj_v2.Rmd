...
# Build df
df_forecast <- data.frame(louisiana_df$n_months, y, HMM_forecast, y_filt_LG, y_filt_LG_lb, y_filt_LG_ub, y_filt_LG_v, y_filt_LG_v_lb, y_filt_LG_v_ub, y_filt_LG_v_seas, y_filt_LG_v_seas_lb, y_filt_LG_v_seas_ub, y_filt_DR, y_filt_DR_lb, y_filt_DR_ub) 
colnames(df_forecast) <- c("n_months", "y", "HMM_forecast", "y_filt_LG", "y_filt_LG_lb", "y_filt_LG_ub", "y_filt_LG_v", "y_filt_LG_v_lb", "y_filt_LG_v_ub", "y_filt_LG_v_seas", "y_filt_LG_v_seas_lb", "y_filt_LG_v_seas_ub", "y_filt_DR", "y_filt_DR_lb", "y_filt_DR_ub") 
