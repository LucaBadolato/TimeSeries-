...
HMM_main <- ggplot(df_to_plot, aes(x=xtime, y=yvalue)) +
  ...
  scale_y_continuous(breaks=seq(0,1.5,0.25)) +
   theme(axis.text.x=element_text(size=18, family="Times", margin=margin(t=8)),
         axis.text.y=element_text(size=18, family="Times", margin=margin(r=8)),
         axis.title.x=element_text(size=18, family="Times", margin=margin(t=8)),
         axis.title.y=element_text(size=18, family="Times", margin=margin(r=8)),
         panel.grid.major=element_line(size=0.5),
         panel.grid.minor=element_blank(),
...
HMM_additional <- ggplot(HMM_additional_CO, aes(time_index, value)) +
  ...
  theme(panel.spacing=unit(1.5, "lines"),
        axis.text.x=element_text(size=18, family="Times", margin=margin(t=8)),
        axis.text.y=element_text(size=18, family="Times", margin=margin(r=8, l=8)),
        axis.title.x=element_text(size=18, family="Times", margin=margin(t=8)),
...
\begin{cases}
  ...
  \overset{iid}\sim \mathcal{N}_{2}(0, W = \begin{bmatrix}\sigma_{w}^{2} & 0 & \cdots  & 0 \\ 0 & 0 & \cdots & 0 \\  \vdots & & \ddots & \vdots \\  0 & 0 & \cdots & 0 \end{bmatrix})
  \\
  \end{cases}
\end{align*}
...
\end{equation*}
and $G=I_2$ and $W=\text{diag}(\sigma_{W_{1}}^{2}, \sigma_{W_{2}}^{2})$, i.e the two time varying coefficients $\alpha_t$ and $\beta_t$ are modeled as independent random walks. 
...
ggplot(df_co_ci, aes(x=n_months)) +
  ...
  scale_x_continuous(breaks=seq(0,186,24),
                     labels=format(seq(as.Date("2001/1/1"),as.Date("2016/6/1"), "2 years"), "%Y")) +
  scale_y_continuous() +
  theme(axis.text.x=element_text(family="Times", margin=margin(t=5)),
        axis.text.y=element_text(family="Times", margin=margin(r=5)),
...
ggplot(df_filt, aes(x=n_months)) +
  ...
  scale_x_continuous(breaks=seq(0,186,24),
                     labels=format(seq(as.Date("2001/1/1"),as.Date("2016/6/1"), "2 years"), "%Y")) +
  theme(axis.text.x=element_text(size=8, family="Times", margin=margin(t=5)),
        axis.text.y=element_text(size=8, family="Times", margin=margin(r=5)),
        axis.title.x=element_text(size=8, family="Times", margin=margin(t=5)),
        axis.title.y=element_text(size=8, family="Times", margin=margin(r=5))) +
