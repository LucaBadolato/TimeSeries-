...
Let's plot the filtering states estimates obtained with the models fitted so far (Figure \ref{fig:filter_est})\footnote{for sake of clarity we decided to report only the temporal window around the breakpoint.}.
