...
colors <- c("Observed data" = "black", "Time-invariant lin. growth" = "springgreen4", 
            "Time-varying lin. growth"="blue", "Time-varying lin. growth + Season"="firebrick","Dynamic regression"="darkorange")
...
plot_LG_V_seas <- ggplot(df_forecast[61:109,], aes(x=n_months)) +
  geom_line(aes(y=y, color="Observed data")) +
  geom_line(aes(y=y_filt_LG_v_seas, color = "Time-varying lin. growth + Season")) +
  geom_vline(xintercept = 85, color= "black", size=0.3) +
  theme_bw(base_size=9) +
  labs(x="Year", y=expression(CO~(ppm)), color = "") +
  scale_y_continuous(breaks=seq(0,1,0.2)) +
