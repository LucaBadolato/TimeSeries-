...
Finally, in Table \ref{tab:for_accuracy} we report the measures of forecasting accuracy for all the models considered. Interestingly, results show that, in this case, introducing dependence across time series of different pollutants does not lead to sizable improvements ude to the so called \textit{borrowing of strenght}. Indeed, the SUTSE is the best model only according to the MAE, while the MSE and MAPE select less sophisticated specifications.
